...
public sealed partial class DestructibleSystem
{
    ...
    /// </summary>
    public void TestAllTriggers(List<Entity<InjurableComponent, DestructibleComponent>> destructibles)
    {
    ...
    /// </summary>
    public void TestAllBehaviors(List<Entity<InjurableComponent, DestructibleComponent>> destructibles)
    {
       foreach (var (uid, damageable, destructible) in destructibles)
       {
           foreach (var threshold in destructible.Thresholds)
