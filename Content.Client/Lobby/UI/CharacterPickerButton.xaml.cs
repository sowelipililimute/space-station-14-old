...
public sealed partial class CharacterPickerButton : ContainerButton
{
        ...
        bool isSelected)
    {
        ...
        {
            _previewDummy = entityManager.SpawnEntity(prototypeManager.Index<SpeciesPrototype>(HumanoidCharacterProfile.DefaultSpecies).OFMAppearancePrototype, MapCoordinates.Nullspace);
        }
        else
        {
